...
if ( ! function_exists( 'twentynineteen_thumbnail_categories_and_tags' ) ) :
	function twentynineteen_thumbnail_categories_and_tags(){
...
if ( ! function_exists( 'twentynineteen_entry_footer' ) ) :
	...
	function twentynineteen_entry_footer() {
		...
		printf('<div class="wrapper-avatar"><img src="'.esc_url( home_url( '/' ) ).'/wp-content/themes/myministry/myministry/img/avatar.png" alt="author"></div>');
			// Posted on
		...
		// Comment count.
		printf('<div class="meta-comments-edit">');
		//read more
		printf('<span> <a href="'.esc_url( get_permalink()).'">Читать</a></span>');
