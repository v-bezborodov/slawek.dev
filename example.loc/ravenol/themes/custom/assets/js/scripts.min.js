...
$(window).on('load', function(){
	$('.menu-wrap').css('opacity','1');
});
$(function() {
	// mobile__menu
	$("#my-menu").mmenu({
		extensions: ["shadow-page" , "pagedim-black", "fx-menu-zoom", "fx-listitems-slide"],
		navbar: {
			title: "Ravenol"
		}
	});
	$("#my-menu").mmenu();
	var a = $("#my-menu").data("mmenu");
	...
	$('#product-slider').not(".slick-initialized").slick({
		...
		adaptiveHeight: !0,
		touchThreshold: 15,
		nextArrow: '<span class="slick-next arrow-right"><i class="fas fa-caret-right"></i></span>',
		prevArrow: '<span class="slick-prev arrow-left"><i class="fas fa-caret-left"></i></span>',
		responsive: [{
			breakpoint: 768,
			settings: {
				variableWidth: !1
		...
		var productShow = $(".product-slider");
		productShow.slick({
			dots: !1,
			rows: 1,
			speed: 300,
			...
			prevArrow: '<span class="arrow-left slick-prev slick-arrow"></span>'
		}), 
		productShow.on("afterChange", (function(productShow, e, n) {
			$("li.slider-thumbs").eq(n).addClass("selected").siblings().removeClass("selected")
		})),
		$("li.slider-thumbs").on("click", (function() {
			$(this).addClass("selected").siblings().removeClass("selected"), productShow.slick("slickGoTo", $(".slick-pager li").index(this))
		}));
	// youtube
	...
	// main__menu
	$('.main__menu > .li__submenu').on('click', function(){
		$('.main__menu > .li__submenu').removeClass('active');
	...
	$(document).mouseup(function (e){
		var div = $(".main__menu>li.active>.submenu");
	...
	// 	e = t.find("a"),
	// 	n = t.find(".canister");
	// 	n.hide(), e.bind("click", (function(e) {
	// 		e.preventDefault();
	// 		var r = $(this).text(),
	// 		i = t.find("#description" + r);
	// 		n.hide(), i.show()
	// 	}))
	// }))
